...
Partial Public Class UserDataSet
    ...
    Partial Public Class UserDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddUserRow(ByVal Username As String, ByVal Email As String, ByVal PhoneNumber As String, ByVal Password As String) As UserRow
            Dim rowUserRow As UserRow = CType(Me.NewRow,UserRow)
            Dim columnValuesArray() As Object = New Object() {Username, Email, PhoneNumber, Password}
...
Namespace UserDataSetTableAdapters
    ...
    Partial Public Class UserTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `User` WHERE ((`Username` = ?) AND ((? = 1 AND `Email` IS NULL) OR (`"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `User` (`Username`, `Email`, `PhoneNumber`, `Password`) VALUES (?, ?,"& _ 
                " ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `User` SET `Username` = ?, `Email` = ?, `PhoneNumber` = ?, `Password` = ? "& _ 
                "WHERE ((`Username` = ?) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)) AND ("& _ 
                "(? = 1 AND `PhoneNumber` IS NULL) OR (`PhoneNumber` = ?)) AND ((? = 1 AND `Passw"& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.GP_New_1.My.MySettings.Default.UserConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Username, Email, PhoneNumber, [Password] FROM [User]"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As UserDataSet.UserDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As UserDataSet.UserDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As UserDataSet.UserDataTable = New UserDataSet.UserDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As UserDataSet.UserDataTable) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Username As String, ByVal Original_Email As String, ByVal Original_PhoneNumber As String, ByVal Original_Password As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Username As String, ByVal Email As String, ByVal PhoneNumber As String, ByVal Password As String, ByVal Original_Username As String, ByVal Original_Email As String, ByVal Original_PhoneNumber As String, ByVal Original_Password As String) As Integer
            If (Username Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Username")
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Email As String, ByVal PhoneNumber As String, ByVal Password As String, ByVal Original_Username As String, ByVal Original_Email As String, ByVal Original_PhoneNumber As String, ByVal Original_Password As String) As Integer
            Return Me.Update(Original_Username, Email, PhoneNumber, Password, Original_Username, Original_Email, Original_PhoneNumber, Original_Password)
        End Function
    End Class
